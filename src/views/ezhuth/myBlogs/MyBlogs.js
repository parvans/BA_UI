...
export default function MyBlogs() {
  ...
  const [scelLoading, setScelLoading] = useState(true);
  ...
  return (
    <div className="content">
      ...
      <LeaveModal
        ...
        toggleEditOrAdd={toggleEditOrAdd}
      />
              ...
              {openAdd || edit ? (
                  ...
                  <>
                    ...
                    <Form>
                      ...
                      <div className="form-group d-flex justify-content-end">
                        <Button
                          className="btn btn-secondary btn-md btn-round"
                          onClick={saveToDraft}
                        >
                          {draftLoading ? (
                            <Spinner
                        ...
                        <Button
                          className="btn btn-primary btn-md btn-round ml-3"
                          onClick={edit ? editBlog : addBlog}
                        >
                ...
                <CardBody>
                  <CardHeader className="d-flex justify-content-between">
                    ...
                    <Button
                      className="btn btn-primary btn-md btn-round mt-1"
                  ...
                  <TabView>
                    <TabPanel
                      header={`Posts ${tc(blogs?.length, {
                        digits: 1,
                        uppercase: false,
                      })}`}
                      leftIcon="pi pi-fw pi-book"
                    >
                      {blogs.length === 0 ? (
                        scelLoading ? (
                        <DataTable
                          ...
                          >
                            ...
                            <Column
                              ...
                              body={(e) => (
                                <>
                                  <Button
                                    className="btn btn-primary btn-sm mr-2 btn-round mt-1"
                                    onClick={() => {
                                  ...
                                  <Button
                                    className="btn btn-warning btn-sm mr-2 btn-round mt-1"
                                    onClick={async () => {
                                      setEdit(!edit);
                                      setBlogId(e._id);
                                  ...
                                  <Button
                                    className="btn btn-danger btn-sm btn-round mt-1"
                                    onClick={() => {
                                      toggle();
                                      setBlogId(e._id);
                                    }}
                    ...
                    <TabPanel
                      header={`Drafts ${tc(drafts?.length, {
                        digits: 1,
                        uppercase: false,
                      })}`}
                    ...
                    >
                      ...
                      >
                        <Column
                          field="S.No"
                          header="S.No"
                          body={(e) => drafts.indexOf(e) + 1}
                        />
                        <Column field="title" header="Title" sortable />
                        <Column
                          field="createdAt"
                          header="Date"
                          body={(e) => moment(e.createdAt).format("DD-MM-YYYY")}
                          sortable
                        />
                        <Column
                          header="Actions"
                          body={(e) => (
                            <>
                              {/* View the blog */}
                              <Button
                                className="btn btn-success btn-sm mr-2 btn-round mt-1"
                                onClick={() => {
                                  setViewBlog(!viewBlog);
                                  localStorage.setItem("blogId", e._id);
                                }}
                              ...
                              {/* Move the blog to trash */}
                              <Button
                                className="btn btn-danger btn-sm mr-2 btn-round mt-1"
                                onClick={() => {
                                  toggle();
                                  setBlogId(e._id);
                                }}
                              ...
                              {/* Post the blog */}
                              <Button
                                className="btn btn-primary btn-sm btn-round mt-1"
                                onClick={() => {
                                  // togglePost()
                                  setBlogId(e._id);
                                }}
                    ...
                    <TabPanel
                      header={`Trash ${tc(trashs?.length, {
                        digits: 1,
                        uppercase: false,
                      })}`}
                      leftIcon="pi pi-fw pi-trash"
                    >
                      <DataTable
                        value={trashs}
                        showGridlines
